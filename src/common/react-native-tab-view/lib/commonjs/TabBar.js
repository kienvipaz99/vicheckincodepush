...
const getTranslateX = (scrollAmount, maxScrollDistance) =>
  _reactNative.Animated.multiply(
    _reactNative.Platform.OS === 'android' && _reactNative.I18nManager.isRTL
      ? _reactNative.Animated.add(
          maxScrollDistance,
          _reactNative.Animated.multiply(scrollAmount, -1),
        )
      : scrollAmount,
...
const getTabBarWidth = _ref2 => {
  let {navigationState, layout, gap, scrollEnabled, flattenedTabWidth, tabWidths} = _ref2;
...
const normalizeScrollValue = _ref3 => {
  let {layout, navigationState, gap, scrollEnabled, tabWidths, value, flattenedTabWidth} = _ref3;
...
const getScrollAmount = _ref4 => {
  let {layout, navigationState, gap, scrollEnabled, flattenedTabWidth, tabWidths} = _ref4;
  const centerDistance = Array.from({
    ...
    return (
      total + (navigationState.index === i ? (tabWidth + (gap ?? 0)) / 2 : tabWidth + (gap ?? 0))
    );
  }, 0);
...
const renderIndicatorDefault = props =>
  /*#__PURE__*/ React.createElement(_TabBarIndicator.default, props);
...
function TabBar(_ref9) {
  ...
  const hasMeasuredTabWidths =
    Boolean(layout.width) && routes.every(r => typeof tabWidths[r.key] === 'number');
  React.useEffect(() => {
    if (isFirst.current) {
  ...
  const renderItem = React.useCallback(
    _ref10 => {
      ...
      const props = {
        ...
        onLongPress: () =>
          onTabLongPress === null || onTabLongPress === void 0
            ? void 0
            : onTabLongPress({
                route,
              }),
      ...
      return /*#__PURE__*/ React.createElement(
        ...
        renderTabBarItem
          ...
          : /*#__PURE__*/ React.createElement(_TabBarItem.default, props),
      );
    },
    [
      activeColor,
